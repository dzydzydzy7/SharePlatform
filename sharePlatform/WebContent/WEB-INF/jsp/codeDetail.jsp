...
<body>
	...
	<div class="layui-col-md12">
		<div class="layui-card">
			<div class="layui-card-header"
				style="font-weight: bold; font-size: 24px;">${code.name }</div>
			<div class="layui-card-header">作者：${code.author}&emsp;&emsp;
				领域：${code.field }&emsp;&emsp;
				上传时间：${code.uploadtime }&emsp;&emsp; 被下载次数：${code.downtimes }</div>
			<div class="layui-card-body">简介：${code.intro }</div>
			<div class="layui-card-header">
				相关的论文：
			...
			<div class="layui-card-body">
				<form method="post" name="theForm"
					action="${pageContext.request.contextPath }/source/downCode?id=${code.id}">
	...
	<form method="post" action="${pageContext.request.contextPath }/source/commentCode?id=${code.id }">
		<div class="layui-row">
