...
<body>
	...
	<form class="layui-form" method="post" name="theForm" enctype="multipart/form-data"
		action="${pageContext.request.contextPath }/source/doUploadCode">
		...
		<div class="layui-form-item">
			<label class="layui-form-label"> 代码作者: </label>
			<div class="layui-input-block">
		...
		<div class="layui-form-item">
			<label class="layui-form-label"> 对应论文: </label>
			<div class="layui-input-block">
				<select name="paper">
		...
		<div class="layui-form-item">
			<label class="layui-form-label"> 代码简介: </label>
			<div class="layui-input-block">
