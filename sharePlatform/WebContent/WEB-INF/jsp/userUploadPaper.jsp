...
<body>
	...
	<form class="layui-form" method="post" name="theForm" enctype="multipart/form-data"
		action="${pageContext.request.contextPath }/source/doUploadPaper">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="journal" class="layui-input" />
			</div>
		</div>
		<div class="layui-form-item">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
      			<textarea class="layui-textarea" name="abstarct"></textarea>
    		</div>
		</div>
		<div class="layui-form-item">
			<div class="layui-input-block">
